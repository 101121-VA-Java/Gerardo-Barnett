...
//			System.out.println(it);
			...
			User g = new User();
			Task t3 = new BoringTask("cleaning", LocalDate.parse("2021-10-21"));
			g.setTask(t3);
			g.setUsername("brayden");
			g.setPassword("1234");
			g.setAge(26);
			
			System.out.println(g);
			
//			String username, String password, int age, Task task
		}
...
//
			...
			// Upcasting
			Task t = new BoringTask("dishes", LocalDate.now());
			Task t2 = new ImportantTask("Java exercise", LocalDate.parse("2021-10-31"));
			Task t3 = new BoringTask("cleaning", LocalDate.parse("2021-10-21"));
